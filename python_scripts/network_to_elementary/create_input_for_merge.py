...
def get_bbox_as_list_of_list(scale):
    ...
    for lat1, lon1, lat2, lon2 in bbox_list:
        bbox_lol.append([lat1, lon1, lat2, lon2])
    return bbox_list
...
def get_islands_bboxes_for_best_fit_hierarchy(bbox_list):
    ...
    for lat1, lon1, lat2, lon2 in bbox_list:
        ...
        if poly_1.intersects(bb_poly):
            island_1.append([lat1, lon1, lat2, lon2])
        if poly_2.intersects(bb_poly):
            island_2.append([lat1, lon1, lat2, lon2])
...
if __name__ == "__main__":
    ...
    dict_islands = get_islands_bboxes_for_best_fit_hierarchy(dict_bbox["hierarchy_" + str(best_fit_hierarchy)])
