...
def plot_data_by_model(df, model_types, city_list):
    for model in model_types:
        ...
        plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_1_inverted.pdf",dpi=300)

        # plt.gca().invert_xaxis()
        # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/nonrecurrent_Fi_1.pdf",dpi=300)
        plt.show()
...
plt.xlabel("Scale")
plt.tight_layout();
plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_2a_orig.pdf", dpi=300)
plt.show()
...
plt.grid(alpha=0.3)
# plt.savefig("../../urbanscalesresults/../../urbanscalesresults/RC_histogram.pdf", dpi=300)
# plt.show()
...
if "heatmapplotunfiltered" == "heatmapplotunfiltered":
    ...
    plt.tight_layout()
    plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_2a.pdf", dpi=300)
    plt.show()
...
plt.xlabel("Scale")
plt.tight_layout();
plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_2b_orig.pdf", dpi=300)
plt.show()
...
if "heatmapplotunOtsu" == "heatmapplotunOtsu":
    ...
    plt.xlabel("Scale", fontsize=25)
    plt.tight_layout()
    plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_2b.pdf", dpi=300)
    plt.show()
...
plt.tight_layout()
plt.tight_layout();
plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_2c_orig.pdf", dpi=300)
plt.show()
...
if "heatmapplotunOtsuSelected50" == "heatmapplotunOtsuSelected50":
    ...
    plt.xlabel("Scale", fontsize=25)
    plt.tight_layout()
    plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_2c.pdf", dpi=300)
    plt.show()
...
if 1==1: # trick to allow code folding :)
    ...
    plt.tight_layout();
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_3a.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    if HARDCODED_CLUSTER == 0:
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout();
        # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_3b.pdf", dpi=300)
        # plt.show()
        plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_3c.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_3d.pdf", dpi=300)
    # plt.show()
    plt.clf()
...
if 1==1: # allow code folding
    ...
    plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4a_orig.pdf", dpi=300)
    plt.show()
    ...
    if "heatmaptratioSign" == "heatmaptratioSign":
        ...
        plt.xlabel("Scale", fontsize=25)
        plt.tight_layout()
        plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4a.pdf", dpi=300)
        plt.show()
    ...
    plt.tight_layout();
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4b.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fig5_var_abs_SR_Positive.pdf", dpi=300)
    # plt.show()
    ...
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fig5_var_abs_SR_Negative.pdf", dpi=300)
    # plt.show()
    plt.clf()
    print ("\n\n\n\n")
    ...
    plt.tight_layout()
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/DTW_recurent_selected_postive_features.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4d.pdf", dpi=300)
    # plt.show()
    plt.clf()
    # Display the dictionary
    ...
    if HARDCODED_CLUSTER == 0:
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout();
        plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4e.pdf", dpi=300)
        plt.show()
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout();
        # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4f.pdf", dpi=300)
        # plt.show()
    ...
    # plt.tight_layout();
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4g.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../../urbanscalesresults/../../urbanscalesresults/recurrent_Fi_4h.pdf", dpi=300)
    # plt.show()
    #
    plt.clf()
