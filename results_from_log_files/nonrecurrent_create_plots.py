...
def plot_data_by_model(df, model_types, city_list):
    for model in model_types:
        ...
        plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_1_inverted.pdf",dpi=300)
...
plt.xlabel("Scale")
plt.tight_layout();
plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_2a_orig.pdf", dpi=300)
plt.show()
...
plt.grid(alpha=0.3)
# plt.savefig("../urbanscales_results/plots/NRC_histogram.pdf", dpi=300)
# plt.show()
plt.clf()
...
if "heatmapplotunfiltered" == "heatmapplotunfiltered":
    ...
    plt.tight_layout()
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_2a.pdf", dpi=300)
    # plt.show()
    plt.clf()
...
# plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_2b_orig.pdf", dpi=300)
# plt.show()
plt.clf()
...
if "heatmapplotunOtsu" == "heatmapplotunOtsu":
    ...
    plt.xlabel("Scale", fontsize=25)
    plt.tight_layout()
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_2b.pdf", dpi=300)
    # plt.show()
    plt.clf()
...
plt.tight_layout()
plt.tight_layout();
# plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_2c_orig.pdf", dpi=300)
# plt.show()
plt.clf()
...
if "heatmapplotunOtsuSelected50" == "heatmapplotunOtsuSelected50":
    ...
    plt.xlabel("Scale", fontsize=25)
    # plt.tight_layout()
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_2c.pdf", dpi=300)
    # plt.show()
    plt.clf()
...
if 1==1: # trick to allow code folding :)
    ...
    plt.tight_layout();
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_3a.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    if HARDCODED_CLUSTER == 0:
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout();
        # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_3b.pdf", dpi=300)
        # plt.show()
        plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_3c.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_3d.pdf", dpi=300)
    # plt.show()
    plt.clf()
...
if 1==1: # allow code folding
    ...
    plt.tight_layout();
    plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4a_orig.pdf", dpi=300)
    plt.show()
    ...
    if "heatmaptratioSign" == "heatmaptratioSign":
        ...
        plt.xlabel("Scale", fontsize=25)
        plt.tight_layout()
        plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4a.pdf", dpi=300)
        plt.show()
    ...
    plt.tight_layout();
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4b.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fig5_var_abs_SR_Positive.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fig5_var_abs_SR_Negative.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    plt.tight_layout()
    # plt.savefig("../urbanscales_results/plots/DTW_nonrecurent_selected_postive_features.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4c.pdf", dpi=300)
    # plt.tight_layout();
    # plt.show()
    plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4d.pdf", dpi=300)
    # plt.show()
    plt.clf()
    # Display the dictionary
    ...
    if HARDCODED_CLUSTER == 0:
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout();
        # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4e.pdf", dpi=300)
        # plt.show()
        plt.clf()
        ...
        plt.grid(True, alpha=0.3)
        plt.tight_layout();
        # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4f.pdf", dpi=300)
        # plt.show()'
        plt.clf()
    ...
    # plt.tight_layout();
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4g.pdf", dpi=300)
    # plt.show()
    plt.clf()
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout();
    # plt.savefig("../urbanscales_results/plots/nonrecurrent_Fi_4h.pdf", dpi=300)
    # plt.show()
    plt.clf()
