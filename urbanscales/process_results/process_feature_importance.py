...
for tod in range(0, 24):
    for model in ["RF"]:# ["RF", "GB"]:
        for marker_type in ["val", "train"]:
            ...
            csv_file_path = os.path.join("/Users/nishant/Downloads/results_50x50_rerun_Aug_9_all_tods_max", "feature_importance.csv")
            ...
            for k in [3]:# [1, 2, 3, 4, 5]:
                ...
                plt.tight_layout()
                plt.savefig(os.path.join("/Users/nishant/Downloads/results_50x50_rerun_Aug_9_all_tods_max", model + "_" + marker_type + "_Top_" + str(k) +"tod:" +str(tod)+ ".png"), dpi=300)
                plt.show()
